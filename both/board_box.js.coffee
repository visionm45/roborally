...
# custom
  ...
  @boards:
    default: () ->
      ...
      return board
    the_big_one: () ->
      board = new Board('the_big_one', 1, 12, 24, 40)
      board.length = 'long'
      board.addRallyArea('island', 0, 0, 0)
      board.addRallyArea('spin_zone', 12, 0, 0)
      board.addRallyArea('chop_shop', 0, 16, 270)
      board.addRallyArea('chop_shop', 12, 16, 270)
      board.addRallyArea('cross', 0, 28, 0)
      board.addRallyArea('cross', 12, 28, 0)

      board.addStartArea('crowd', 0, 12, 0)
      board.addStartArea('roller', 12, 12, 0)

      board.addCheckpoint(7, 7)
      board.addCheckpoint(9, 31)
      board.addCheckpoint(1, 8)
      board.addCheckpoint(20, 37)
      board.addCheckpoint(19, 23)
      board.addCheckpoint(17, 4)
